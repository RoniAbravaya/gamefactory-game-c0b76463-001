# Privacy Policy for Test Claude Fix-platformer-01

*Last updated: [DATE]*

## Overview

This privacy policy explains how Test Claude Fix-platformer-01 ("the App") collects, uses, and protects your information.

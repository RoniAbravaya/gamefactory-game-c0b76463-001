...
class GameColors {
  ...
  static const Color primary = Color(0xFFFAD02E);
  static const Color secondary = Color(0xFF58C4DD);
  static const Color accent = Color(0xFFF76C6C);
  static const Color success = Color(0xFFA8D8EA);
  static const Color warning = Color(0xFF8D6E63);
